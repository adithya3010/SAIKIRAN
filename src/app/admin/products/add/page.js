...
export default function AddProductPage() {
    ...
    return (
        <div className="p-8 md:p-12 pb-20 max-w-4xl mx-auto">
            <h1 className="text-4xl font-outfit font-bold uppercase mb-2">Add Product</h1>
            <p className="text-grey-400 mb-10">Create a new item in your catalog.</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-2">
                            ...
                            <input
                                ...
                                className="w-full bg-neutral-900 border border-white/10 p-3 rounded text-white focus:border-white outline-none"
                                required
                            />
                        </div>
                        <div className="space-y-2">
                ...
                <div className="space-y-6">
                    ...
                    <p className="text-xs text-grey-500">Upload product images (Accepted: JPG, PNG, WEBP).</p>
                ...
                <div className="pt-8 border-t border-white/10 flex justify-end">
                    <button
                        type="submit"
                        disabled={isLoading}
                        className={`bg-white text-black px-10 py-4 rounded-full font-bold uppercase tracking-widest hover:bg-grey-200 transition-all ${isLoading ? 'opacity-50 cursor-not-allowed' : ''}`}
                    >
