    ...
    return (
        <div className="min-h-screen bg-black text-white relative overflow-hidden sm:overflow-hidden">
            ...
            <div className="absolute inset-0 lg:hidden pointer-events-none">
                <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_20%,rgba(255,255,255,0.16),rgba(0,0,0,0.75)_45%,rgba(0,0,0,1)_85%)]" />
            ...
            <div className="grid min-h-screen grid-cols-1 lg:grid-cols-2">
                ...
                <div className="relative hidden lg:flex overflow-hidden border-r border-white/10">
                    <div className="absolute inset-0 bg-[radial-gradient(circle_at_70%_35%,rgba(255,255,255,0.18),rgba(0,0,0,0.65)_45%,rgba(0,0,0,1)_80%)]" />
                    ...
                    <div className="relative z-10 flex flex-col justify-between p-12 w-full">
                        <div className="flex items-center gap-3">
                            <div className="relative h-12 w-12">
                                <Image src="/brand.png" alt="Brand" fill className="object-contain" priority />
                            </div>
                            <div className="leading-tight">
                                <div className="font-outfit font-bold uppercase tracking-[0.28em] text-sm">MAY BE NOT</div>
                                <div className="text-white/60 text-xs tracking-widest">MONOCHROME ESSENTIALS</div>
                            </div>
                        </div>
                        ...
                        <div className="max-w-md">
                            <h1 className="font-outfit text-5xl font-bold uppercase tracking-tight leading-[1.05]">
                                Own the
                                <span className="block text-white/70">Unordinary</span>
                            </h1>
                            <p className="mt-4 text-white/70 leading-relaxed">
                                Sign in to manage your orders, addresses, and checkout faster.
                            </p>
                ...
                <div className="flex items-center justify-center px-5 py-6 sm:px-6 sm:py-10 lg:px-12">
                    <div className="w-full max-w-md relative z-10">
                        ...
                        <div className="lg:hidden mb-5 text-center">
                            ...
                            <p className="mt-2 text-white/60 text-sm">Monochrome essentials. Elevated.</p>
                        </div>
                        ...
                        <div className="rounded-2xl border border-white/10 bg-white/5 backdrop-blur-md shadow-[0_20px_80px_rgba(0,0,0,0.55)] p-5 sm:p-6 md:p-8">
                            ...
                            <form className="space-y-4 sm:space-y-5" onSubmit={loginUser}>
